var containerQuestionEl = document.getElementById("question-container");
      ...
      var questions = [
        ...
        { q: 'How does a FOR loop start?', 
          a: '1. for (i = 0; i <= 5; i++)', 
          choices: [{choice: '1. for (i = 0; i <= 5; i++)'}, {choice: '2. for (i = 0; 1 <= 5) '}, {choice: '3. for i = 1 to 5'}, {choice: '4. for (i <= 5; i++)'}]
        },
    ...
    //Displays question information and answer buttons//
    ...
    //Displays correct! on screen when answer is correct//
    ...
    //Displays wrong! on screen when answer is incorrect//
    ...
    var answerCheck = function(event) {
        ...
        //Displays users final score after game is over//
    ...
    //Clears visibile high score list// 
    ...
    //Displays high score screen from link or when intiials entered//
